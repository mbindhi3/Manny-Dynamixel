...
a3TrajectoryConstraint = constraint(0,'a3',0,'trajectory');
a4TrajectoryConstraint = constraint(0,'a4',0,'trajectory');
a5TrajectoryConstraint = constraint(0,'a5',0,'trajectory');
a14TrajectoryConstraint = constraint(-3*pi/4,'a14',pi/8,'trajectory');
a15TrajectoryConstraint = constraint(0,'a15',pi/2,'trajectory');
a16TrajectoryConstraint = constraint(-pi/2,'a16',pi/8,'trajectory');
...
xCoMTrajectoryConstraint = constraint(0,xCoMEquation,1.2,'trajectory');
initialConstraints = a14InitialConstraint + a15InitialConstraint + a16InitialConstraint;
trajectoryConstraints = a3TrajectoryConstraint + a4TrajectoryConstraint + a5TrajectoryConstraint + a14TrajectoryConstraint + a15TrajectoryConstraint + a16TrajectoryConstraint + orientationTrajectoryConstraint + xCoMTrajectoryConstraint + zRightFootBasePositionTrajectoryConstraint;
...
a3val =0* linspace(0,0,100);
a4val = 0*linspace(0,0,100);
a5val = 0*linspace(0,0,100);
a14val = linspace(0,-pi/8,100);
a15val = linspace(0,pi/4,100);
a16val = linspace(0,-pi/8,100);
