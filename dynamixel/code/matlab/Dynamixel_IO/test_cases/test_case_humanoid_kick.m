%% Pre-conditions
% OpenCM9.04 controller + OpenCM 485EXP powered and connected to Manny (via
...
target_pos_hip = -pi/2;   % 60 degrees
target_speed = target_pos_hip/2;  % 2 sec. travel time
...
target_pos_leftleg(3) = target_pos_hip;
...
dxl_io.set_motor_pos_speed(motor_ids_leftleg, zeros(length(motor_ids_leftleg), 1), target_pos_leftleg', target_speed_leftleg' );

pause(2.5);
pos_vel_final = dxl_io.read_present_pos_vel( motor_ids_leftleg, 1);
