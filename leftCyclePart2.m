...
xLeftFootBasePositionTrajectoryConstraint = constraint(0,xLeftFootBaseEquation,2,'trajectory');
...
trajectoryConstraints = a14TrajectoryConstraint + a15TrajectoryConstraint + a16TrajectoryConstraint + xLeftFootBasePositionTrajectoryConstraint + xCOMTrajectoryConstraint + a3TrajectoryConstraint + a4TrajectoryConstraint + a5TrajectoryConstraint + orientationRightFootTrajectoryConstraint + zLeftFootBasePositionTrajectoryConstraint;
