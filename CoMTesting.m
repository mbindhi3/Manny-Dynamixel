...
a15TrajectoryConstraint = constraint(0,'a15',3*pi/4,'trajectory');
a16TrajectoryConstraint = constraint(-pi/2.5,'a16',0,'trajectory');
...
xCOMTrajectoryConstraint = constraint(1.33,xCoMwrtRightFootEquation,1.33,'final');
...
trajectoryConstraints = xCOMTrajectoryConstraint +a14TrajectoryConstraint + a15TrajectoryConstraint+ a16TrajectoryConstraint + a3TrajectoryConstraint + a4TrajectoryConstraint + a5TrajectoryConstraint +  orientationRightFootTrajectoryConstraint + zLeftFootBasePositionTrajectoryConstraint;
allConstraints =  finalConstraints + trajectoryConstraints;
